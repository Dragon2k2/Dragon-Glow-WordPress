...
( function () {
	...
	const root = document.querySelector( '.dg-privacy' );
	if ( ! root ) {
		return;
	}
	...
	function initReveal() {
		const header = root.querySelector( '.dg-privacy-header' );
	...
	function initScrollSpy() {
		...
		const navLinks = root.querySelectorAll( '.dg-privacy-nav-link' );
		const mobileSelect = root.querySelector( '.dg-privacy-toc-select' );
