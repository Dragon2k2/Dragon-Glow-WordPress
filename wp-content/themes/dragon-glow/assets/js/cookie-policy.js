...
( function () {
	...
	const root = document.querySelector( '.dg-cookie' );
	if ( ! root ) {
		return;
	}
	...
	function initScrollSpy() {
		...
		const navLinks = root.querySelectorAll( '.dg-cookie-nav-link' );
		const mobileSelect = root.querySelector( '.dg-cookie-toc-select' );
