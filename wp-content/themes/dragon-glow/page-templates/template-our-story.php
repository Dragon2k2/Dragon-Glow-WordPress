...
<main>
    ...
    <section class="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-margin-mobile reveal-on-scroll">
            ...
            <a href="#philosophy" class="inline-block bg-primary-container hover:bg-primary text-on-primary-container hover:text-white px-10 py-4 uppercase dg-story-eyebrow text-sm transition-all duration-500 leading-none">
                ...
                <div class="reveal-on-scroll lg:order-2">
                    ...
                    <div class="space-y-10">
                        <div class="flex gap-6 group">
                            <span class="font-serif text-primary-container/30 text-5xl transition-colors group-hover:text-primary-container leading-none">01</span>
                            <div>
                        ...
                        <div class="flex gap-6 group">
                            <span class="font-serif text-primary-container/30 text-5xl transition-colors group-hover:text-primary-container leading-none">02</span>
                            <div>
                                <h4 class="font-serif text-primary text-xl mb-2 leading-tight">
                        ...
                        <div class="flex gap-6 group">
                            <span class="font-serif text-primary-container/30 text-5xl transition-colors group-hover:text-primary-container leading-none">03</span>
                            <div>
                                <h4 class="font-serif text-primary text-xl mb-2 leading-tight">
    ...
    <section class="py-section-gap px-5 md:px-16 max-w-container-max mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Bento Item 1 -->
            <div class="md:col-span-2 bg-white p-12 flex flex-col justify-center border dg-story-card-border shadow-sm hover:shadow-md transition-shadow reveal-on-scroll">
                <h3 class="font-serif text-primary text-xl mb-6 leading-tight">
                    <?php esc_html_e( 'Sustainably Sourced', 'dragon-glow' ); ?>
                </h3>
                <p class="text-on-surface-variant mb-8 max-w-lg text-base leading-relaxed">
                ...
                <div class="flex gap-4">
                    <span class="material-symbols-outlined text-primary-container">eco</span>
                    <span class="material-symbols-outlined text-primary-container">psychology_alt</span>
                    <span class="material-symbols-outlined text-primary-container">potted_plant</span>
                </div>
            </div>
            <!-- Bento Item 2 -->
            <div class="dg-story-bento-dark p-12 flex flex-col justify-center text-white reveal-on-scroll">
            ...
            <!-- Bento Item 3 -->
            <div class="dg-story-bento-light p-12 flex flex-col justify-center reveal-on-scroll">
                <h3 class="font-serif text-primary text-xl mb-6 leading-tight">
            ...
            <!-- Bento Item 4 -->
            <div class="md:col-span-2 dg-story-bento-lightest p-12 flex flex-col justify-center border dg-story-card-border reveal-on-scroll">
                <h3 class="font-serif text-primary text-xl mb-6 leading-tight">
                    <?php esc_html_e( 'Minimalist Luxury', 'dragon-glow' ); ?>
                </h3>
                <p class="text-on-surface-variant max-w-lg text-base leading-relaxed">
