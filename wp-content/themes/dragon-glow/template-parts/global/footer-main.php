...
$ingredients_url = get_permalink( get_page_by_path( 'our-ingredients' ) ) ?: '#';
$contact_url      = get_permalink( get_page_by_path( 'contact' ) ) ?: '#';
$help_center_url  = get_permalink( get_page_by_path( 'help-center' ) ) ?: '#';
$faq_url     = get_permalink( get_page_by_path( 'faq' ) ) ?: '#';
$shipping_url = get_permalink( get_page_by_path( 'shipping-returns' ) ) ?: '#';
$gift_cards_url = get_permalink( get_page_by_path( 'gift-cards' ) ) ?: '#';
$sustainability_url = get_permalink( get_page_by_path( 'sustainability' ) ) ?: '#';
$careers_url     = get_permalink( get_page_by_path( 'careers' ) ) ?: '#';
