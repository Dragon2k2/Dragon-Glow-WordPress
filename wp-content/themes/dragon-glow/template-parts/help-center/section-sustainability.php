<?php
/**
 * Dragon Glow — Help Center: Sustainability Practice
...
$data    = dg_hc_data();
$section = $data['sections']['sustainability'];
$faqs    = $section['faqs'];
?>
...
<?php // Empty-state cho search — đặt cuối main để JS tìm thấy. ?>
<div class="dg-hc-empty" id="dg-hc-empty" hidden>
	<p class="dg-hc-empty-title"><?php esc_html_e( 'No match.', 'dragon-glow' ); ?></p>
	<p class="dg-hc-empty-text"><?php esc_html_e( 'Try a different word, or write to us.', 'dragon-glow' ); ?></p>
</div>