<?php
/**
 * Dragon Glow — Help Center: Orders & Delivery
 * Section header (icon + title) + single-open accordion.
 * Item đầu có CTA "Track Order" nếu FAQ đó set has_cta.
 *
 * @package Dragon_Glow
 */
			...
			<div class="dg-hc-faq-item" data-hc-item data-sr>
				...
				>
					<div class="dg-hc-faq-panel-inner">
						...
						<?php if ( $has_cta ) : ?>
						<a class="dg-hc-faq-cta" href="<?php echo esc_url( $faq['cta_url'] ?? $data['orders_url'] ); ?>">
							<?php echo esc_html( $faq['cta_label'] ?? __( 'Track Order', 'dragon-glow' ) ); ?>
						</a>
						<?php endif; ?>
					</div>
				</div>
