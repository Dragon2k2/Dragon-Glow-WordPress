...
$cta_text  = get_theme_mod( 'dg_shop_philosophy_cta', __( 'The Dragon Glow Story', 'dragon-glow' ) );
	...
	<div class="px-margin-mobile md:px-margin-desktop max-w-container-max-width mx-auto">
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center">
			...
			<div class="reveal-on-scroll active">
				...
				<h2 class="font-headline-lg text-headline-lg text-on-surface mb-8" style="font-family: 'Geist', sans-serif; color: #735C00;">
					<?php echo esc_html( $title ); ?>
				</h2>
				<p class="font-body-lg text-body-lg text-on-surface-variant mb-6 leading-relaxed" style="font-family: 'Geist', sans-serif; color: #000000;">
				...
				<ul class="space-y-4 mb-10">
					<?php foreach ( $bullets as $bullet ) : ?>
						...
						<li class="flex items-center gap-4 group cursor-default">
							...
							<span class="font-body-md text-body-md italic text-on-surface group-hover:text-[#D4AF37] transition-colors duration-300 text-[#000000]" style="font-family: 'Geist', sans-serif;">
