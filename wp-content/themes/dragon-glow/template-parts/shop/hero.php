...
<header class="relative w-full h-[90vh] overflow-hidden flex items-center" id="dg-shop-hero">
	...
	<div class="relative z-10 px-margin-mobile md:px-margin-desktop max-w-container-max-width mx-auto w-full">
		<div class="max-w-2xl reveal-on-scroll active">
			<span class="font-label-sm text-label-sm text-primary tracking-[0.2em] mb-4 block" style="font-family: 'Geist', sans-serif">
			...
			<p class="font-body-lg text-body-lg text-on-surface mb-10 max-w-lg" style="font-family: 'Geist', sans-serif">
				<?php echo esc_html( $hero_text ); ?>
			</p>
			<div class="flex flex-wrap gap-6">
				<a class="btn-luxury btn-luxury--filled bg-primary text-on-primary px-10 py-4 font-label-sm text-label-sm uppercase tracking-widest hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(115,92,0,0.35)]"
				   href="<?php echo esc_url( $hero_btn1_url ); ?>">
					<?php echo esc_html( $hero_btn1_text ); ?>
				</a>
				<a class="btn-luxury border border-primary text-primary px-10 py-4 font-label-sm text-label-sm uppercase tracking-widest hover:bg-primary/10 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(115,92,0,0.25)]"
