...
<section class="py-section-gap bg-surface" id="dg-shop-rituals">
	<div class="text-center mb-20 px-margin-mobile reveal-on-scroll active">
		<h2 class="font-headline-lg text-headline-lg text-on-surface mb-4" style="font-family: 'Geist', sans-serif; color: #735C00;">
			<?php echo esc_html( $section_title ); ?>
		</h2>
		<p class="font-body-md text-body-md text-on-surface-variant max-w-xl mx-auto" style="font-family: 'Geist', sans-serif; color: #000000;">
		...
		<a class="flex-1 group cursor-pointer product-card-hover reveal-on-scroll active" href="<?php echo esc_url( $am_url ); ?>">
			<div class="relative h-[600px] overflow-hidden mb-8">
				...
				<div class="absolute bottom-10 left-10 text-white transform group-hover:-translate-y-2 transition-transform duration-500">
					<span class="font-label-sm text-label-sm uppercase tracking-[0.3em] mb-2 block" style="font-family: 'Geist', sans-serif">
						<?php echo esc_html( $am_eyebrow ); ?>
					</span>
					<h3 class="font-headline-md text-headline-md text-[#f1ca50]" style="font-family: 'Geist', sans-serif; text-shadow: 0 2px 12px rgba(0,0,0,0.7)">
