...
<div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6 reveal-on-scroll active" id="dg-curated-header">
	<div class="max-w-xl">
		...
		<p class="font-body-md text-body-md text-on-surface-variant" style="font-family: 'Geist', sans-serif; color: #000000;">
	...
	<div class="relative shrink-0 self-end">
		<button type="button"
			...
			<span class="dg-filter-trigger-text font-label-sm text-label-sm text-outline border-b border-outline pb-1 filter-transition" style="font-family: 'Geist', sans-serif">
