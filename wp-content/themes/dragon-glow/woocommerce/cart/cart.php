...
// Check if cart has items (must be initialized before the layout if/endif below)
...
<div class="min-h-screen relative pb-section-gap">
<div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12">

    <!-- Page heading -->
    <div class="mb-10">
        <h1 class="dg-cart-title font-headline text-headline-lg text-primary leading-tight">
            <span class="dg-cart-title__icon dg-cart-title__icon--gold" aria-hidden="true">
                <svg viewBox="0 0 32 32" fill="none" focusable="false">
                    <path d="M5 7h3l2 11h14l2-8H10"
                    ...
                    <table class="w-full border-collapse" id="dg-cart-table">
                        ...
                        <tr class="dg-cart-row group border-b border-outline-variant/20 last:border-0"
                            ...
                            <td class="py-7 text-right">
                                <span class="font-body text-[18px] text-primary">
